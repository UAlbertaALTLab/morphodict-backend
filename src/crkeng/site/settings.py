...
from morphodict import base_dir_setup

BASE_DIR = Path(__file__).resolve().parent.parent

base_dir_setup.set_base_dir(BASE_DIR)

from morphodict.settings import *

# Where this application should be deployed:
PRODUCTION_HOST = "api.itwewina2.altlab.dev"
...
MORPHODICT_ORTHOGRAPHY = {
    ...
    "available": {
        ...
        "Latn-x-macron": {
            "name": "SRO (ēīōā)",
            "converter": "orthography.to_macrons",
        },
        "Cans": {
            "name": "Syllabics",
            "converter": "orthography.to_syllabics",
        },
    },
}
