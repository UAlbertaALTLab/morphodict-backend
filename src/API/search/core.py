...
class SearchRun:
    ...
    _results: dict[WordformKey, api_types.Result]
    ...
    def add_result(self, result: api_types.Result):
        if not isinstance(result, api_types.Result):
    ...
    def has_result(self, result: api_types.Result):
        return result.wordform.key in self._results

    def remove_result(self, result: api_types.Result):
        del self._results[result.wordform.key]

    def unsorted_results(self) -> Iterable[api_types.Result]:
        return self._results.values()

    def sorted_results(self) -> list[api_types.Result]:
